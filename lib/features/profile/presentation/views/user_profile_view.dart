...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    final profileTitle =
        widget.mode == 'provider' ? 'Provider profile' : 'Customer profile';
    final profileSubtitle = widget.mode == 'provider'
        ? 'Build trust with a polished service profile.'
        : 'Keep your contact details ready for faster bookings.';
